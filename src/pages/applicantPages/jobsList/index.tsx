...
const Jobslist = () => {
    ...
    const handleSearch =  () => {
       ...
       apiRequest({url: `jobs?${queryParams.toString()}`}).then((response) => {
        if(response.status) {
        ...
        <div className={styles.inner_container}>
            <div className={styles.top_bar}>
                <div className={styles.search_job}>
                    <input type='search' placeholder='Job title or keyword' className={styles.search_1} value={title} onChange={e => setTitle(e.target.value)}/>
                </div>
                <div className={styles.search_location}>
                    <input type='search' placeholder='Location or remote' className={styles.search_2} value={location} onChange={e => setLocation(e.target.value)}/>
                </div>
                <div className={styles.btn_container}>
                    <button className={styles.search_btn} onClick={handleSearch}>Search Jobs</button>
                </div>
            </div>
