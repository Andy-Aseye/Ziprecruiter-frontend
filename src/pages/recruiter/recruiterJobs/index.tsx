...
const RecruiterJob = ({id, location, title, jobtype, salary, skills}: RJobProps) => {
  ...
  return (
    <div className={styles.job_container}>
        ...
        <div className={styles.actions}>
            <div><button className={styles.view} onClick={handleViewApp}>View applicants</button></div>
            <div><button className={styles.edit} onClick={handleUpdate}>Edit job</button></div>
